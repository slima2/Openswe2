# Script optimizado para iniciar OpenSWE con configuración de memoria aumentada
# Soluciona problemas de "JavaScript heap out of memory"
...
Write-Host "Open Software Engineering Agent - Optimized Mode" -ForegroundColor Yellow
Write-Host "============================================" -ForegroundColor Cyan

# Configuración de memoria optimizada
$env:NODE_OPTIONS = "--max-old-space-size=4096 --max-semi-space-size=512"
Write-Host "[CONFIG] Configuración de memoria optimizada:" -ForegroundColor Green
Write-Host "  - Heap máximo: 4GB" -ForegroundColor White
Write-Host "  - Semi-space: 512MB" -ForegroundColor White
...
Write-Host "[STARTING] Iniciando servicios con configuración optimizada..." -ForegroundColor Yellow

# Iniciar API Server (Agent) en background con memoria aumentada
...
# Iniciar Web Interface en background con memoria aumentada
...
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Servicios iniciados con configuración optimizada:" -ForegroundColor Green
...
Write-Host "`n🎉 Sistema GPTfy iniciado con configuración optimizada!" -ForegroundColor Green
Write-Host "💡 Para detener los servidores, cierra las ventanas de PowerShell" -ForegroundColor Cyan
Write-Host "💾 Configuración de memoria: 4GB heap máximo" -ForegroundColor Cyan
